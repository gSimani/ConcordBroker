...
export function BusinessEntitySection({ parcelId, ownerName, address }: BusinessEntitySectionProps) {
  ...
  return (
    <Card className="elegant-card animate-elegant">
      ...
      <CardContent>
        {matches.length === 0 ? (
          <div className="text-center py-8">
            ...
            <Button onClick={runEntityMatching} className="btn-outline-executive">
              <span>Run Entity Matching</span>
            </Button>
          </div>
        ) : (
          <Tabs defaultValue="matches" className="w-full">
            <div className="tabs-executive flex justify-center mb-6">
              <TabsTrigger value="matches" className="tab-executive">Matches ({matches.length})</TabsTrigger>
              <TabsTrigger value="details" className="tab-executive">Entity Details</TabsTrigger>
              <TabsTrigger value="portfolio" className="tab-executive">Portfolio</TabsTrigger>
              <TabsTrigger value="network" className="tab-executive">Network</TabsTrigger>
            </div>
