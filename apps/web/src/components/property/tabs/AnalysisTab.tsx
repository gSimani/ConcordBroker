          ...
          <h3 className="elegant-card-title gold-accent flex items-center justify-between">
            ...
            <div className="text-center p-3 rounded-lg" style={{background: 'linear-gradient(135deg, #f4e5c2 0%, #fff 100%)'}}>
              <div className={`text-3xl font-light mb-1 ${
                ...
                investmentScore >= 60 ? 'text-gold' : 'text-red-600'
              }`}>
                {investmentScore}/100
              </div>
        ...
        <div className="pt-8">
            ...
            <div className="relative h-3 bg-gray-light rounded-full overflow-hidden">
              <motion.div
                ...
                className={`h-full rounded-full ${
                  ...
                  investmentScore >= 60 ? 'bg-gold' : 'bg-red-500'
                }`}
                style={{
                  background: investmentScore >= 80 ? 
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <motion.div 
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
              className="p-6 rounded-lg bg-orange-50 border-l-4 border-orange-500"
            >
              ...
              <ul className="space-y-3 text-sm">
                ...
                {metrics.propertyAge > 50 && (
                  <li className="flex items-center text-orange-700">
                    <Clock className="w-4 h-4 mr-2" />
                    <span>Older property requiring updates (-5 points)</span>
                  </li>
                )}
                {(!lastSale?.is_distressed && !lastSale?.is_bank_sale && totalNavAssessment === 0 && metrics.pricePerSqft <= 400 && metrics.propertyAge <= 50) && (
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <p className={`text-3xl font-light mb-1 ${
            metrics.capRate >= 8 ? 'text-green-600' : 
            metrics.capRate >= 6 ? 'text-gold' : 'text-red-600'
          }`}>
        ...
        >
          ...
          <p className={`text-3xl font-light mb-1 ${
            metrics.pricePerSqft > 0 && metrics.pricePerSqft < 200 ? 'text-green-600' : 
            metrics.pricePerSqft < 400 ? 'text-gold' : 'text-red-600'
          }`}>
            ${metrics.pricePerSqft > 0 ? Math.round(metrics.pricePerSqft) : 'N/A'}
          </p>
        ...
        >
          ...
          <p className={`text-3xl font-light mb-1 ${
            metrics.propertyAge < 20 ? 'text-green-600' : 
            metrics.propertyAge < 40 ? 'text-gold' : 'text-red-600'
          }`}>
            {metrics.propertyAge} yrs
          </p>
        ...
        <div className="pt-8">
          ...
          {metrics.appreciationTrend !== 0 && (
            <motion.div 
              ...
              className="p-6 rounded-lg bg-blue-50 border border-blue-200 mb-8"
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-blue-600">Based on historical sales data</p>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="text-center">
                    ...
                    <span className={`text-3xl font-light ${
                      metrics.appreciationTrend > 0 ? 'text-green-600' : 'text-red-600'
                    }`}>
                ...
                {metrics.marketValue > 0 && metrics.salePrice > 0 && (
                  <div className="flex justify-between items-center py-3 border-t border-gold bg-gold-light rounded p-3">
                    ...
                    <span className={`text-xl font-light ${
                      metrics.marketValue > metrics.salePrice ? 'text-green-600' : 'text-red-600'
                    }`}>
          ...
          {investmentScore >= 80 ? (
            <div className="p-8 rounded-lg border-l-4 border-green-500" style={{background: 'linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%)'}}>
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h4 className="text-2xl font-light elegant-text text-green-800 mb-2 flex items-center">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h5 className="font-medium text-green-800 mb-3">Strategic Advantages</h5>
            ...
            <div className="p-8 rounded-lg border-l-4 border-yellow-500" style={{background: 'linear-gradient(135deg, #fffbeb 0%, #fef3c7 100%)'}}>
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h4 className="text-2xl font-light elegant-text text-yellow-800 mb-2 flex items-center">
                ...
                <span className="badge-elegant bg-yellow-100 text-yellow-800 border-yellow-200 text-sm">CONDITIONAL</span>
              </div>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h5 className="font-medium text-yellow-800 mb-3">Due Diligence Required</h5>
                ...
                <div>
                  <h5 className="font-medium text-yellow-800 mb-3">Strategic Considerations</h5>
                  <ul className="space-y-2 text-sm text-yellow-700">
                    <li className="flex items-start">
            ...
            <div className="p-8 rounded-lg border-l-4 border-red-500" style={{background: 'linear-gradient(135deg, #fef2f2 0%, #fecaca 100%)'}}>
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h4 className="text-2xl font-light elegant-text text-red-800 mb-2 flex items-center">
                ...
                <span className="badge-elegant bg-red-100 text-red-800 border-red-200 text-sm">CAUTION</span>
              </div>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h5 className="font-medium text-red-800 mb-3">Risk Mitigation</h5>
                ...
                <div>
                  <h5 className="font-medium text-red-800 mb-3">Alternative Strategy</h5>
                  <ul className="space-y-2 text-sm text-red-700">
                    <li className="flex items-start">
