...
const isProduction = import.meta.env.PROD || window.location.hostname === 'www.concordbroker.com' || window.location.hostname === 'concordbroker.com';

// Base URLs - automatically switch between localhost and production
const BASE_URLS = {
  FRONTEND: import.meta.env.VITE_APP_URL || (isProduction ? 'https://www.concordbroker.com' : 'http://localhost:5173'),
  PROPERTY_API: import.meta.env.VITE_API_URL || (isProduction ? 'https://www.concordbroker.com' : 'http://localhost:8000'),
  VISUALIZATION_API: import.meta.env.VITE_VISUALIZATION_API_URL || (isProduction ? 'https://www.concordbroker.com' : 'http://localhost:8002'),
  ...
  SUPABASE: import.meta.env.VITE_SUPABASE_URL || 'https://hnrpyufhgyuxqzwtbptg.supabase.co'
};
...
export const WEBSOCKET_URLS = {
  ...
  PROPERTY_UPDATES: `ws://localhost:8001/ws`
};
