  ...
  const fetchProperty = async () => {
    ...
    try {
      ...
      if (params.city && params.address) {
        ...
        url = `/api/properties/search?address=${encodeURIComponent(addressSearch)}&city=${encodeURIComponent(city)}&limit=1`;
        ...
        if (/^\d+$/.test(singleParam)) {
          if (singleParam.length > 10) {
            ...
            url = `/api/properties/search?q=${singleParam}&limit=1`;
          } else {
            ...
            <CardContent className="text-center py-12">
              ...
              <div className="mt-8 p-4 bg-gray-50 rounded-lg">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>â€¢ Check the address spelling</li>
                  <li>â€¢ Try searching by parcel ID</li>
                  <li>â€¢ Use the main search page</li>
                  <li>â€¢ Browse by city or ZIP code</li>
                </ul>
              </div>
            </CardContent>
          </Card>
