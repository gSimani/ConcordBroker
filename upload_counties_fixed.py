"""
Fixed Property Appraiser Upload Script
...
def upload_county_data(county_folder: str, progress_file: str):
    ...
    with open(progress_file, 'a') as f:
        ...
        if errors:
            f.write(f"  Errors: {len(errors)} (varchar issues fixed)\n")
...
def main():
    """Main execution"""
    print("=" * 60)
    print("FLORIDA PROPERTY APPRAISER DATA UPLOAD (FIXED)")
    print("=" * 60)
    
    base_path = r"C:\Users\gsima\Documents\MyProject\ConcordBroker\TEMP\DATABASE PROPERTY APP"
    progress_file = "upload_progress_fixed.txt"
