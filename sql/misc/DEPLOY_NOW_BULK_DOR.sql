-- ==============================================================================
-- DEPLOY NOW: BULK DOR CODE ASSIGNMENT
-- ==============================================================================
        ...
        WITH calculated_codes AS (
            SELECT
                ...
                CASE
                    ...
                    WHEN just_value > 500000 AND building_value > 200000 AND land_value * 0.3 <= building_value AND building_value <= COALESCE(NULLIF(land_value, 0), 1) * 4 THEN '17'
                    WHEN land_value > building_value * 5 AND land_value > 100000 THEN '01'
                    WHEN just_value BETWEEN 100000 AND 500000 AND building_value BETWEEN 50000 AND 300000 THEN '03'
                ...
                CASE
                    ...
                    WHEN just_value > 500000 AND building_value > 200000 AND land_value * 0.3 <= building_value AND building_value <= COALESCE(NULLIF(land_value, 0), 1) * 4 THEN 'Commercia'
                    ...
                    WHEN building_value > 50000 AND building_value > land_value AND just_value < 1000000 THEN 'SFR'
                    ELSE 'SFR'
...
SELECT
    ...
    ROUND(100.0 * COUNT(CASE WHEN land_use_code IS NOT NULL THEN 1 END) / COUNT(*), 1) as pct_coded
FROM florida_parcels
WHERE year = 2025
GROUP BY county
ORDER BY total DESC;
...
RAISE NOTICE 'Done! Check results above.';
