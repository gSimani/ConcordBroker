...
echo [1/5] Starting MCP Server (Port 3001)...
echo ----------------------------------------------------------------
start "MCP Server" cmd /k "cd mcp-server && npm start"
timeout /t 3 /nobreak >nul

echo [2/5] Starting React Frontend (Port 5173)...
echo ----------------------------------------------------------------
...
echo [4/5] Initializing MCP Services...
echo ----------------------------------------------------------------
start "MCP Init" cmd /k "node claude-code-init.cjs"
timeout /t 3 /nobreak >nul
